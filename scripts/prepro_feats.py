...
import sys
sys.path.append("/home/alfa/Documents/caption/transfer")
...
if __name__ == "__main__":
  ...
  parser.add_argument('--att_size', default=14, type=int, help='14x14 or 7x7, which is the size of attention maps.')
  parser.add_argument('--model', default='resnet101', type=str, help='resnet50, resnet101, resnet152')
  parser.add_argument('--model_root', default='./data/imagenet_weights', type=str, help='model root')

  args = parser.parse_args()
  params = vars(args) # convert to ordinary dict
  print('parsed input parameters:')
  print(json.dumps(params, indent = 2)) # print in the format of json
  main(params)
